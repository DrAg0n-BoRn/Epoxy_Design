...
from helpers.constants import TENSILE_STRENGTH as REGRESSION_TARGET
```

```python
SCHEMA_PATH = PM.engineering_artifacts
TRAIN_DATASET_FILE = PM.chain_tensile_file

TRAIN_ARTIFACTS_DIR = PM.chain_tensile
...
trainer.evaluate(save_dir=TRAIN_EVALUATION_DIR,
                ...
                val_format_configuration=FormatRegressionMetrics(scatter_color='tab:orange'),
                test_format_configuration=FormatRegressionMetrics(scatter_color='tab:brown'),
                )
```
